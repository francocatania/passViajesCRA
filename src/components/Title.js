  ...
  render() {
    return (
      <div className="titleContainer titleContainer--animated">
        ...
        <h2 className="titleContainer__descriptionText">Servicio de transporte privado para CABA y Gran Buenos Aires. Con una capacidad de hasta <span className="titleContainer__relevant-text">7 pasajeros</span>, ofrecemos la alternativa perfecta para viajes familiares y corporativos. Consulte por todos nuestros servicios.</h2>
      </div>
    );
  }
}
